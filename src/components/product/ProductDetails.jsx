...
const ProductDetails = () => {
  ...
  const product =
    products[products.findIndex((current) => current.name === id)];
      ...
      <div className="md:grid md:grid-cols-2 md:py-10">
        {product ? (
          <>
            <div className="">
              {isLoading ? (
                <div className="h-64 bg-slate-200 grid place-content-center">
                  {" "}
                  <BagImgLoader />{" "}
                </div>
              ) : null}
            ...
            <div className="text-center">
              ...
              <div className="flex-col text-center">
                ...
                <div className="border flex justify-evenly border-black p-2 w-4/12 mx-auto">
                  ...
                  <input
                    ...
                    onChange={inputQuantityHandle}
                  />
                  <button className="font-semibold" onClick={incrementHandle}>
                    +
                  </button>
                </div>
              </div>
              ...
              <div className="flex-col content-center">
                <button
                  className="block border border-black w-11/12 p-2 my-4 mx-auto"
                ...
                <Link
                  to="/products"
                  className="block border border-black w-11/12 p-2 my-4 bg-black text-white mx-auto uppercase"
                >
                  Continue Shopping
                </Link>
              </div>

              <p className="text-center my-8"> {product.description}</p>
            </div>
          </>
        ) : (
          <Loading />
