    ...
    <div className="border-t">
      <div className=" h-screen bg-stone-50 fixed right-0 w-screen top-0  md:h-[100vh] overflow-y-auto md:w-1/3 md:top-16 drop-shadow-2xl z-50 ">
        <div className="flex justify-between p-2">
          {" "}
          <h2 className="text-xl font-extrabold">Bag</h2>
        ...
        {bag.length >= 1 ? (
          <div className="flex-col content-center">
            ...
            <Link to="/checkout">
              <button
                ...
                className="block border border-black w-11/12 p-2 my-4 bg-black text-white mx-auto"
              >
                CHECKOUT
              </button>
            </Link>
          ...
          <p className="text-center py-20">No items on Bag</p>
        )}
        <Link
          to="/products"
          className="block border border-black w-11/12 p-2 my-4 bg-black text-white mx-auto uppercase text-center"
          onClick={props.toggle}
        >
          Continue Shopping
        </Link>
