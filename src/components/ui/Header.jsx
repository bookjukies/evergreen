  ...
  return (
    ...
    <header className="shadow-lg h-16 flex justify-between px-4 sticky top-0 bg-white md:px-12 z-50">
      { toggleCross? <button onClick={toggleHandle}><Cross /> </button>:
        ...
        <Link to="/" className="block self-center text-xl font-bold" onClick={closeBars}>
          Evergreen Pasture
        </Link>
        <nav className="hidden md:flex md:justify-self-center md:self-center md:gap-8 text-xl font-bold">
          <Link to="/products" className="block focus:text-slate-500 hover:text-slate-500">
            Shop
          </Link>
          <Link to="/track-order" className="block focus:text-slate-500 hover:text-slate-500">
            Track Order
          </Link>
          <Link to="/ebook" className="block focus:text-slate-500 hover:text-slate-500">
            Ebook
          </Link>
          <a href="/#faq" className="block focus:text-slate-500 hover:text-slate-500">
            FAQ
          </a>
        </nav>
